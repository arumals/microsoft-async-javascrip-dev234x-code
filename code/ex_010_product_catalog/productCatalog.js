...
document.getElementById('idButton').addEventListener('click', () => {
    processSearch(document.getElementById('idInput').value);
});
document.getElementById('typeButton').addEventListener('click', () => {
    api.searchProductsByType(document.getElementById('typeInput').value).then((val) => {
...
document.getElementById('inputButton').addEventListener('click', () => {
    api.searchProductsByPrice(document.getElementById('priceInput').value, 10).then((val) => {
        updateTable('similarTable', val);
    }).catch((err) => {
        alert(err);
    });
